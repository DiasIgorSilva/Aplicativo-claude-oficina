...
import { useState, useEffect, useRef } from 'react';
    ...
    export default function App() {
      ...
      return (
        <div style={{ minHeight: "100vh", background: "#0b0d14", color: "#f8fafc", fontFamily: "'Plus Jakarta Sans', sans-serif", display: "flex", flexDirection: "column", paddingBottom: 85, width: "100%" }}>
          ...
          {/* MODAIS */}
          {showReport && <ReportModal services={services} viewMode={globalViewMode} onClose={() => setShowReport(false)} onGenerate={(f, t) => { generatePDF(vehicles, services, expenses, f, t, globalViewMode); setShowReport(false); }} />}
          {showDriveModal && (
            <DriveModal 
              driveUrl={driveUrl} 
    ...
    // ── ABA INÍCIO ─────────────────────────────────────────────────────────────
    function Dashboard({ services, viewMode, setViewMode, onEditService }) {
          ...
          <div className="card" style={{ background: "linear-gradient(135deg, #141824, #0d101a)", border: "1px solid #1c2234", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
            <div>
              ...
              <p style={{ fontSize: 12, color: "#94a3b8", marginTop: 4 }}>
                Monitore a última visita dos clientes, previna o churn e gere mensagens com IA em 2 segundos para ativá-los via WhatsApp.
              </p>
            </div>
