      ...
      return (
        ...
        <div style={{ minHeight: "100vh", background: "#0b0d14", color: "#f8fafc", fontFamily: "'Plus Jakarta Sans', sans-serif", display: "flex", flexDirection: "column", paddingBottom: 85, width: "100%" }}>
          ...
          <style>{`
            ...
            @import url('https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Russo+One&family=Syne:wght@700;800&display=swap');
          ...
          <header className="header-bar">
            <div className="logo-box" style={{ display: 'flex', alignItems: 'center' }}>
              <svg height="40" viewBox="0 0 350 72" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', height: '40px', width: 'auto' }}>
                {/* Outermost White Contour */}
                <text x="4" y="46" fontFamily="'Chakra Petch', 'Russo One', sans-serif" fontWeight="900" fontSize="48" letterSpacing="-1.5" fill="none" stroke="#FFFFFF" strokeWidth="8" strokeLinejoin="miter">ASDCAR</text>
                {/* Inner Black Contour */}
                <text x="4" y="46" fontFamily="'Chakra Petch', 'Russo One', sans-serif" fontWeight="900" fontSize="48" letterSpacing="-1.5" fill="none" stroke="#000000" strokeWidth="3" strokeLinejoin="miter">ASDCAR</text>
                
                {/* ASD Red Fill */}
                <text x="4" y="46" fontFamily="'Chakra Petch', 'Russo One', sans-serif" fontWeight="900" fontSize="48" letterSpacing="-1.5" fill="#FF1E27">ASD</text>
                {/* CAR White Fill */}
                <text x="146" y="46" fontFamily="'Chakra Petch', 'Russo One', sans-serif" fontWeight="900" fontSize="48" letterSpacing="-1.5" fill="#FFFFFF">CAR</text>
                
                {/* Red Underline Bar */}
                <path d="M 4 54 L 345 54 L 340 68 L 4 68 Z" fill="#FF1E27"/>
                {/* Subtitle MECÂNICA AUTOMOTIVA */}
