      ...
      return (
        ...
        <div style={{ minHeight: "100vh", background: "#0b0d14", color: "#f8fafc", fontFamily: "'Plus Jakarta Sans', sans-serif", display: "flex", flexDirection: "column", paddingBottom: 85, width: "100%" }}>
          ...
          <style>{`
            ...
            @import url('https://fonts.googleapis.com/css2?family=Chakra+Petch:ital,wght@1,800;1,900&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Syne:wght@700;800&display=swap');
    ...
    .workshop-car-card { cursor: pointer; transition: all 0.2s ease; }
          ...
          <header className="header-bar">
            <div className="logo-box" style={{ display: 'flex', alignItems: 'center' }}>
              <svg height="40" viewBox="0 0 350 72" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', height: '40px', width: 'auto' }}>
                <defs>
                  <linearGradient id="asdRedGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#FF1E27" />
                    <stop offset="100%" stopColor="#D9000B" />
                  </linearGradient>
                </defs>
                <text x="4" y="46" fontFamily="'Chakra Petch', 'Orbitron', 'Syne', sans-serif" fontWeight="900" fontStyle="italic" fontSize="48" letterSpacing="-1.5" fill="none" stroke="#FFFFFF" strokeWidth="8" strokeLinejoin="miter">ASDCAR</text>
                <text x="4" y="46" fontFamily="'Chakra Petch', 'Orbitron', 'Syne', sans-serif" fontWeight="900" fontStyle="italic" fontSize="48" letterSpacing="-1.5" fill="none" stroke="#000000" strokeWidth="4" strokeLinejoin="miter">ASDCAR</text>
                <text x="4" y="46" fontFamily="'Chakra Petch', 'Orbitron', 'Syne', sans-serif" fontWeight="900" fontStyle="italic" fontSize="48" letterSpacing="-1.5" fill="url(#asdRedGrad)">ASD</text>
                <text x="145" y="46" fontFamily="'Chakra Petch', 'Orbitron', 'Syne', sans-serif" fontWeight="900" fontStyle="italic" fontSize="48" letterSpacing="-1.5" fill="#FFFFFF">CAR</text>
                <path d="M 4 54 L 345 54 L 340 68 L 4 68 Z" fill="#FF1E27"/>
                <text x="336" y="65" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="800" fontSize="10.5" fill="#FFFFFF" textAnchor="end" letterSpacing="1.2">MECÂNICA AUTOMOTIVA</text>
              </svg>
            </div>
